...
@test "doctor names a deleted-source home dangle in the stale section (#46)" {
  ...
  cp "$REPO/bin/lib/common.sh" "$REPO/bin/lib/profile.sh" "$REPO/bin/lib/brew.sh" "$REPO/bin/lib/links.sh" "$REPO/bin/lib/sdkman.sh" "$REPO/bin/lib/reconcile.sh" "$SANDBOX/dotfiles/bin/lib/"
