...
| File                                     | Purpose                                                                                                                                                                                                                                                                                                                              |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `~/.gitconfig-local`                     | Machine-local git config from `dot git setup`/`install-guard`: name, email, `github.user`, `credential.helper`, and the Identity Guard's `core.hooksPath`. Since #157 an unbound repo hard-fails the commit (`useConfigOnly`) rather than falling back to the name/email here — those fields are legacy, tracked for removal in #158 |
